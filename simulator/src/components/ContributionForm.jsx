...
class ContributionForm extends Component {
  ...
  render() {
    ...
    var contributionAmount = (fundTotalAsFloat * contributionPercentageAsDecimal).toFixed(2);
      ...
      <section className="simulator-form">
        <div className="contribution-form">
          ...
          <div className="form-group">
            ...
            <InputRange
              ...
              step={0.1}
              onChange={value => this.setState({ contributionPercentage: value })}
            />
          </div>
        </div>
        <div className="contribution-results">
          <div className="form-group">
            ...
            <h2>
              <FontAwesomeIcon icon={faDollarSign} />
              <span id="contribution-result">{numberWithCommas(contributionAmount)}</span>
            </h2>
          </div>
        </div>
      </section>
